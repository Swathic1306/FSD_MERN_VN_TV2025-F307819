...
const Information=[
        ...
        },
         {
            ...
            Name:"Theekshana",
            Role:"AI Developer",
            Image:"https://images.unsplash.com/photo-1762444760659-54caed7cbb1a?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGlubm9jZW50JTIwZ2lybHxlbnwwfHwwfHx8MA%3D%3D"
         }
    ]
  return ( 
      ...
      {Information.map((info,i)=>{
        return(
                ...
                <div className="card-body" key={i}>
                    ...
                    <h5 className="card-title">{info.Role}</h5>
                </div>
                </div>
